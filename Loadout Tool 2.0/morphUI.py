...
headerFont = ("Calibri", int(12*scaleFactor), 'bold')
summaryFont = ("Calibri", int(11*scaleFactor), 'bold')
summaryFontStats = ("Calibri", int(11*scaleFactor))
baseFont = ("Calibri", int(10*scaleFactor), 'bold')
baseFontStats = ("Calibri", int(10*scaleFactor), 'bold')
buttonFont = ("Calibri", int(13*scaleFactor), 'bold')
fontPadding = 0
elementPadding = 4
bgColor = '#202225'
boxColor = '#313338'
