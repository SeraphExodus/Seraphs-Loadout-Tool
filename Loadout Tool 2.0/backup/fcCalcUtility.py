...
def fcCalc(*dcs):
    ...
    window = sg.Window('Flight Computer Calculator', Layout, modal=False, icon=os.path.abspath(os.path.join(os.path.dirname(__file__), 'SLT_Icon.ico')), size=(640,550), finalize=True)
